...
// An array of ServerResponse Object that we're going to "send" events to
let clients = [];
...
server.on("request", (request, response) => {
    ...
    // Otherwise the /chat is a POST of a new message
    else {
...
async function broadcastNewMessage(request, response) {
    // First, read the body of the request to get the user' smessage
